        ...
        <div class="col-md-2">
            ...
            <div class="card card-body ">
                <form action="simpan.php" method="POST">
                    ...
                    <div class="form-group">
                        <input type="text" name="devisi" class="form-control" placeholder="Isi Devisi Anda!" autofocus>
                        <br>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="alamat" class="form-control" rows="4" placeholder="Isikan Alamat"></textarea>
                    </div><br>
